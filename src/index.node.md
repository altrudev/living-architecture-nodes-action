...
Main entrypoint orchestrating config, scan, checks, export, outputs, and exit code.
...
Calls: src/config.js, src/scanner.js, src/checker.js, src/exporter.js, src/summary.js, src/github-io.js.

Called by: GitHub Actions runner / local Node process.
