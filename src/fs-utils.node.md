# src/fs-utils.js — Living Architecture Node

## Static layer

### Purpose and responsibility boundary

Filesystem, directory walking, and path normalization helpers.
...
Called by: src/scanner.js, src/exporter.js, src/git.js.
