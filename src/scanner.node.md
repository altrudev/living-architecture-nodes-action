# src/scanner.js — Living Architecture Node

## Static layer

### Purpose and responsibility boundary

Repository source scanning and source-to-node mapping.
...
Calls: src/fs-utils.js, src/config.js.
...
- Adjusted node-file discovery so `CHANGELOG.node.md` is treated as a required artifact, not an orphan companion node.
